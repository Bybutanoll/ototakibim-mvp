      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600">Bakım Gerekli</p>
                <p className="text-2xl font-semibold text-gray-900">0</p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">Araçlarınızı yönetin</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">İş emirlerini takip edin</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">Randevuları planlayın</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-gray-900">Stok</h3>
                <p className="text-gray-600">Stok yönetimi</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-gray-600">Ödeme takibi</p>
              </div>
            </div>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-gray-400 mt-2">Araç ekleyerek başlayın</p>
          </div>
        </div>
      </main>
    </div>
