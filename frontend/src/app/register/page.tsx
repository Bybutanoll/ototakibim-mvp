...
import { Eye, EyeOff, Mail, Lock, User, Phone, Building, Car, ArrowRight, CheckCircle } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const checkPasswordStrength = (password: string) => {
    ...
    if (score === 0) feedback = 'Çok zayıf';
    else if (score === 1) feedback = 'Zayıf';
    else if (score === 2) feedback = 'Orta';
    else if (score === 3) feedback = 'Güçlü';
    else if (score === 4) feedback = 'Çok güçlü';
    else feedback = 'Mükemmel';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await register({
        ...
        role: 'technician', // Varsayılan rol olarak technician
      });
    } catch (error) {
      ...
      <div className="relative z-10 max-w-lg w-full space-y-8">
        ...
        >
          ...
          <p className="text-gray-600">
            OtoTakibim'e katılın ve araç sağlığınızı koruyun
          </p>
        </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label htmlFor="company" className="block text-sm font-medium text-slate-700 mb-2">
                Şirket <span className="text-gray-500">(Opsiyonel)</span>
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
